export const Alert = () => {
    return (
        <div className="alert alert-error shadow-lg fixed bottom-10 left-10 animation-bounce z-50 w-5/12 border-2 border-red-700 text-black">
            <div>
                ...
                <span className="font-bold ">Error! failed to connect to the database</span>
            </div>
        </div>
    )
}